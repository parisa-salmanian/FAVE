...
function collectDRData(maxPts = Infinity, normalize = true, colorBy = 'overall', runNonce = 0, universeCap = Infinity) {
  ...
  if (mode === 'district') {
    ...
    const districtLabels = {
      ...
      grocery: 'grocery access (z)',
      hospital: 'hospital access (z)',
      primary: 'primary school access (z)',
      pharmacy: 'pharmacy access (z)',
      healthcare: 'healthcare center access (z)',
      kindergarten: 'kindergarten access (z)',
      schoolHigh: 'high school access (z)',
      university: 'university access (z)',
      dentistry: 'dentistry access (z)',
      veterinary: 'veterinary access (z)',
...
const DR_FEATURE_CONFIG = [
  ...
  { key: 'fairGrocery',  label: 'Grocery access' },
  { key: 'fairHospital', label: 'Hospital access' },
  { key: 'fairPrimary',  label: 'Primary school access' },
  { key: 'fairPharmacy',     label: 'Pharmacy access' },
  { key: 'fairHealthcare',   label: 'Healthcare center access' },
  { key: 'fairKindergarten', label: 'Kindergarten access' },
  { key: 'fairSchoolHigh',   label: 'High school access' },
