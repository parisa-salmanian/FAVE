...
let overallGiniTrue = null;       // true bounded Gini (0..1), shown beside GE(2)
let currentCategoryGini = null;  // per-selection GE(2); updated on every compute/clear
let currentCategoryGiniTrue = null;  // per-selection true Gini (0..1), beside GE(2)
