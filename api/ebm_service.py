...
def run_ebm_ranking(
    ...
    try:
        ...
        # Note: we used to strip generic "feature N" labels here, but in
        # some interpret versions ALL term_names are generic which left
        # importances=[] and the UI showed "No informative features".
        # The frontend already remaps generic labels to the original
        # feature names sent in feature_names, so just return everything.
